<?php
	...
	ob_start();
		...
		$head = '<h3 style="text-align: center">Laporan Kelas Sistem Informasi Interaksi Dosen dan Mahasiswa</h3>';
	    ...
	    $content = '<table width="100%" cellpadding="5" border="0.6">
						<thead>
							<tr>
								...
								<th width="22%" align="center" valign="middle">Nama Kelas</th>
								<th width="23%" align="center" valign="middle">Jurusan</th>
								<th width="30%" align="center" valign="middle">Nama Perguruan Tinggi</th>
					...
					foreach ($query as $row) {
						...
						$content .= '<tr>';
							...
							$content .= '<td width="22%">'.$row->nama_kelas.'</td>';
							$content .= '<td width="23%">'.$row->jurusan.'</td>';
							$content .= '<td width="30%">'.$row->nama_pt.'</td>';
